...
import com.example.demo.expecation.GetPetById;
...
@SpringBootTest
@DisplayName("GetPetByIdTest")
@Duration
@ExtendWith(GetPetById.class)
class GetPetByIdTest extends MockServerTestBase implements LifecycleLogger {

  private static final String API_PATH = SERVER_URL + "/pet/{petId}";
